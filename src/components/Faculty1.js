  ...
  return (
    ...
    <div className={classes.root}>
        ...
        <Grid container spacing={9}>
          ...
          <div width="50%">
          <button className={classes.previous} ><a style={{
            color:"#fff"
          }} textDecoration='none' href="/components/Faculty"> <ChevronLeftIcon/> </a></button> 
          </div>
          <div width="50%">
          <button className={classes.next} float="right"><a style={{color:"#fff"}} textDecoration='none' href="/components/Faculty2"><ChevronRightIcon/> </a></button>
          </div>
